// Realizar una página con un script que calcule el valor de la letra de un número de DNI (Documento nacional de identidad). El algoritmo para calcular la letra del dni es el siguiente : El número debe ser entre 0 y 99999999
...
while (true) {
  var dni = prompt("Introduzca su número de DNI entre 0 y 99999999:");
  ...
  alert(`La letra correspondiente a su número de DNI es: ${letra}`);
}
